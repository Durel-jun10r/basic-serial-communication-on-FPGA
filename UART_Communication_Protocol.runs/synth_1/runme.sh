...
HD_PWD='C:/Users/junio/Documents/FPGA_project/UART_project/UART_Communication_Protocol/UART_Communication_Protocol.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_top_module.tcl
