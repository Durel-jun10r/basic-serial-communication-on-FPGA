...
HD_PWD='C:/Users/junio/Documents/FPGA_project/UART_project/UART_Communication_Protocol/UART_Communication_Protocol.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rx_top_module.tcl -notrace
