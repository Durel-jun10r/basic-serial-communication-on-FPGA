...
REM
REM Generated by Vivado on Sun May 31 10:20:14 +0100 2026
...
echo "xvlog --incr --relax -prj uart_rx_simulation_vlog.prj"
call xvlog  --incr --relax -prj uart_rx_simulation_vlog.prj -log xvlog.log
